...
@section('content')
    ...
    <div class="content px-3">
        ...
        <div class="card tabla-container" id="productos-table-container">
...
<script>
    $(document).ready(function() {
        ...
        function loadTable(url) {
            $.ajax({
                ...
                success: function(data) {
                    $('#productos-table-container').html(data); 
                },
                error: function(xhr) {
        ...
        // --- 2. PAGINACIÓN ---
        $(document).on('click', '#productos-table-container .pagination a', function(e) {
            e.preventDefault();
        ...
        $('form[method="GET"]').on('submit', function(e) {
             if ($(this).find('input[name="buscar"]').length > 0 && 
                 ...
                 var url = '{{ route('productos.index') }}' + '?buscar=' + buscar;
                 loadTable(url);
             }
        });
        ...
        $('body').on('click', '.btn-historial', function() {
            var id = $(this).data('id');
            var tabla = $(this).data('tabla'); // 'productos'
