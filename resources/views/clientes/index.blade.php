...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    {{-- BOTÓN DE AYUDA --}}
                    <a class="btn btn-default float-right mr-2" href="{{ asset('manuales/manual_clientes.pdf') }}" target="_blank"
    ...
    <div class="content px-3">
        ...
        <div class="card tabla-container" id="clientes-table-container">
...
<script>
    $(document).ready(function() {
        ...
        function loadTable(url) {
            $.ajax({
                ...
                success: function(data) {
                    $('#clientes-table-container').html(data); 
                },
                error: function(xhr) {
        ...
        // --- 2. PAGINACIÓN ---
        $(document).on('click', '#clientes-table-container .pagination a', function(e) {
            e.preventDefault();
        ...
        $('form[method="GET"]').on('submit', function(e) {
             if ($(this).find('input[name="buscar"]').length > 0 && 
                 ...
                 var url = '{{ route('clientes.index') }}' + '?buscar=' + buscar;
                 loadTable(url);
             }
        });
        ...
        $('body').on('click', '.btn-historial', function() {
            var id = $(this).data('id');
            var tabla = $(this).data('tabla'); // 'clientes'
