...
@section('content')
    ...
    <div class="content px-3">
        ...
        <div class="card tabla-container" id="marcas-table-container"> 
...
<script>
    $(document).ready(function() {
        ...
        function loadTable(url) {
            $.ajax({
                ...
                success: function(data) {
                    $('#marcas-table-container').html(data); 
                },
                error: function(xhr) {
        ...
        // --- 2. PAGINACIÓN ---
        $(document).on('click', '#marcas-table-container .pagination a', function(e) {
            e.preventDefault();
        ...
        $('form[method="GET"]').on('submit', function(e) {
             if ($(this).find('input[name="buscar"]').length > 0 && 
                 ...
                 var url = '{{ route('marcas.index') }}' + '?buscar=' + buscar;
                 loadTable(url);
             }
        });
        ...
        $('body').on('click', '.btn-historial', function() {
            var id = $(this).data('id');
            var tabla = $(this).data('tabla'); // 'marcas'
