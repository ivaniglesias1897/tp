    ...
    <script>
        $(document).ready(function() {
            ...
            $('#btn-consultar').click(function(e) {
                e.preventDefault();
                window.location.href = '{{ url('reporte-proveedores') }}?desde=' + $('#desde').val() +
                    '&hasta=' + $('#hasta').val();
            });
            ...
            $('#btn-exportar').click(function(e) {
                e.preventDefault();
                window.open('{{ url('reporte-proveedores') }}?desde=' + $('#desde').val() + '&exportar=pdf',
                    '_blank');
            });

            $('#btn-exportar-excel').click(function(e) {
                e.preventDefault();
                window.open('{{ url('reporte-proveedores') }}?desde=' + $('#desde').val() +
            ...
            $('#btn-limpiar').click(function(e) {
                ...
                $('#desde').val('');
                $('#hasta').val('');
                window.location.href = '{{ url('reporte-proveedores') }}';
            });
        });
    </script>
@endpush
