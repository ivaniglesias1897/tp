                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <button class="btn btn-success" id="btn-exportar-excel" type="button" data-toggle="tooltip"
                            ...
                            style="margin-top:32px; background-color: #28a745; border-color: #28a745; color: white;">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#btn-consultar').click(function(e) {
                e.preventDefault();
                window.location.href = '{{ url('reporte-productos') }}?desde=' + $('#desde').val() +
                    '&hasta=' + $('#hasta').val();
            });
            ...
            $('#btn-exportar').click(function(e) {
                e.preventDefault();
                window.open('{{ url('reporte-productos') }}?desde=' + $('#desde').val() + '&hasta=' + $(
            ...
            $('#btn-exportar-excel').click(function(e) {
                e.preventDefault();
                window.open('{{ url('reporte-productos') }}?desde=' + $('#desde').val() + '&hasta=' + $(
                    '#hasta').val() + '&exportar=excel', '_blank');
            });
            ...
            $('#btn-limpiar').click(function(e) {
                ...
                $('#desde').val('');
                $('#hasta').val('');
                window.location.href = '{{ url('reporte-productos') }}';
            });
        });
    </script>
@endpush
